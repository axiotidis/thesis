...
urlRef.once("value", function(snapshot) {
		...
		.then(function(snapshot){
			...
			for (i=0; i<customers.length; ++i){
				...
				console.log("path = " + path);
				var userAddrs = snapshot.child(path).val();
				console.log(customers[i] + "Address = " + userAddrs);
				...
				var alertpopup = "<b>Αριθ. Παροχής:</b> " + customers[i] + "<br><b>Διεύθυνση:</b> " + userAddrs + "<br>";
				...
				if (orpIndex || phIndex || tempIndex || trbIndex){
					...
					var safepopup = "<b>Αριθ. Παροχής:</b> " + customers[i] + "<br><b>Διεύθυνση:</b> " + userAddrs + "<br>Το νερό είναι ασφαλές για κατανάλωση";		//prepare a custom popup 
